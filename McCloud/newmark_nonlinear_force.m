...
%
%  Input:
%  Udisp      - N x 1 displacement vector
%  phi        - Nx x N shape modes matrix
%  Nx         - number of mesh points
%  phys_param - physical parameters vector
%
%  Output:
%  FNL        - N x Ndt nonlinear external force matrix
%  dFNL_dU    - N x N   nonlinear external force derivative matrix
% ----------------------------------------------------------------- 
